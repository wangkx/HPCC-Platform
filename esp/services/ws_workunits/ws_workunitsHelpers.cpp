...
// -- this comment will be removed after code review.
    ...
    StringBuffer& zipFileName, StringBuffer& zipFileNameWithPath)
{
    ...
    setZIPFileName(request.zapFileName.str(), zapReportNameStr.str(), zipFileName, zipFileNameWithPath);
...
void CWsWuFileHelper::setZIPFileName(const char* zipFileNameReq, const char* zipFileNamePrefix,
    StringBuffer& zipFileName, StringBuffer& zipFileNameWithPath)
{
    ...
    zipFileNameWithPath.set(getCFD()).append("files").append(PATHSEPCHAR).append("temp");
...
//Clone from void CWsWorkunitsEx::readWUFile()
// -- this comment will be removed after code review.
