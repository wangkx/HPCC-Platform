...
#ifndef _ESPWIZ_ws_tranlogging_HPP__
#define _ESPWIZ_ws_tranlogging_HPP__

#include "ws_tranlogging_esp.ipp"
#include "espp.hpp"
#include "environment.hpp"
#include "logthread.hpp"

class CWSTransactionLogSoapBindingEx : public CWSTransactionLogSoapBinding
{
public:

    CWSTransactionLogSoapBindingEx(http_soap_log_level level=hsl_none) : CWSTransactionLogSoapBinding(level) { };

    CWSTransactionLogSoapBindingEx(IPropertyTree* cfg, const char *bindname, const char *procname, http_soap_log_level level=hsl_none)
        : CWSTransactionLogSoapBinding(cfg, bindname, procname, level) { };
};

class CWSTransactionLogEx : public CWSTransactionLog
{
