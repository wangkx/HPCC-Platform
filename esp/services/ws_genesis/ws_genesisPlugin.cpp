...
{
    if (strcmp(type, "WsGenesis")==0)
    {
        CWsGenesisEx* service = new CWsGenesisEx;
...
{
    if (strcmp(type, "WsGenesisSoapBinding")==0)
    {
        CWsGenesisSoapBindingEx* binding = new CWsGenesisSoapBindingEx(cfg, name, process);
        return binding;
    }
