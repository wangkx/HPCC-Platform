...
{
    if (strcmp(type, "WsPDMService")==0)
    {
        CWsPDMServiceEx* service = new CWsPDMServiceEx;
...
{
    if (streq(type, "WsPDMSoapBinding"))
        return new CWsPDMServiceSoapBinding(cfg, name, process, hsl_none);
