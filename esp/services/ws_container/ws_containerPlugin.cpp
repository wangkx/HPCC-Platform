...
{
   if (strieq(type, "ws_container"))
   {
      CWsContainerEx* service = new CWsContainerEx;
...
ESP_FACTORY IEspRpcBinding * esp_binding_factory(const char *name, const char* type, IPropertyTree *cfg, const char *process)
{
   ...
   if (strieq(type, "ws_containerSoapBinding") || strieq(type, "ws_container_http"))
   {
        return new CWsContainerSoapBinding(cfg, name, process);
   }
