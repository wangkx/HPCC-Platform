...
#ifndef WsEchoTest_API
#ifdef _WIN32
#define WsEchoTest_API __declspec(dllexport)
#else
#define WsEchoTest_API
#endif //_WIN32
#endif //WsEchoTest_API
...
{
    if (strcmp(type, "WsEchoTest")==0)
    {
        CWsEchoTestEx* service = new CWsEchoTestEx;
...
#endif
        return new CWsEchoTestSoapBinding(cfg, name, process, log_level_);
    }
