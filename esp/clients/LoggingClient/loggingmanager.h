...
{
    virtual bool init(IPropertyTree* loggingConfig, const char* service, const char* process) = 0;
    virtual bool updateLog(const char* option, const char* logContent) = 0;
    virtual bool updateLog(IEspUpdateLogRequest& req, IEspUpdateLogResponse& resp) = 0;
    virtual bool getTransactionSeed(StringBuffer& transactionSeed) = 0;
