...
{
    virtual void Add(const char*, const StringBuffer& strContents, CLogContentInFile* contentInFile)=0;//
    virtual void Add(const char*,IInterface& pIn, CLogContentInFile* contentInFile)=0;
...
public:
    ...
    virtual void Add(const char*, const StringBuffer& strContents, CLogContentInFile* contentInFile);//
    virtual void Add(const char*,IInterface& pIn, CLogContentInFile* contentInFile);
