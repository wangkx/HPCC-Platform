...
public:
    ...
    EsdlDefArray(StartTag &tag, EsdlDefinition *esdl, const bool _isList) : EsdlDefObject(tag, esdl), isList(_isList){}
    ...
    inline const bool checkIsList() { return isList; };
};
...
public:
    ...
    void loadArray(EsdlDefinition *esdl, XmlPullParser *xpp, StartTag &tag, const bool isList)
    {
        EsdlDefArray *art = new EsdlDefArray(tag, esdl, isList);
