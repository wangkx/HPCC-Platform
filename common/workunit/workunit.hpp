...
interface IWorkUnitFactory : extends IInterface
{
    ...
    virtual IConstWorkUnitIterator * getWorkUnitsSorted(WUSortField * sortorder, WUSortField * filters, const void * filterbuf, unsigned startoffset, unsigned maxnum,
                const char * queryowner, const char * querySecUserId, int accessOwn, int accessOthers, __int64 * cachehint, unsigned *total) = 0;
