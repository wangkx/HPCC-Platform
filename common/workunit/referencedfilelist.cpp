...
public:
    ...
    virtual void appendSubFileNames(StringArray &names)
    {
...
public:
    ...
    void ensureFile(const char *ln, unsigned flags, const char *pkgid, bool noDfsResolution, StringArray& subfileNames, const char *daliip=NULL, const char *srcCluster=NULL, const char *remotePrefix=NULL);
...
void ReferencedFileList::ensureFile(const char *ln, unsigned flags, const char *pkgid, bool noDfsResolution, StringArray& subfileNames, const char *daliip, const char *srcCluster, const char *prefix)
{
...
void ReferencedFileList::addFile(const char *ln, const char *daliip, const char *srcCluster, const char *prefix)
{
    ...
    ensureFile(ln, 0, NULL, false, subfiles, daliip, srcCluster, prefix);
}
                ...
                if (pkgid)
                {
                    ...
                    if (ssfe && ssfe->numSubFiles()>0)
                    {
                        ...
                        while (count--)
                        {
                            ...
                            ensureFile(subfile, RefSubFile | RefFileInPackage, pkgid, false, subfiles);
